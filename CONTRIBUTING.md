...
> **Last verified:** 2026-09-19 — document generation reads the same owner
> metadata registry as flake assembly. The Codex named-profile materializer
> cited below as a runtime-writable-files example was removed as unreachable
> dead code.
