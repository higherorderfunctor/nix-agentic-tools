...
- **`ai-module`**
  - Match: `checks/*/module-eval.nix`, `checks/module-provenance/**`,
    ...
    `lib/ai/hooks.nix`, `lib/ai/mkSkillPackageModule.nix`, `lib/ai/own.nix`,
    `lib/ai/own.py`, `lib/ai/program.nix`, `lib/ai/runtime-files.nix`,
    `lib/ai/runtimes.nix`, `lib/ai/sharedOptions.nix`,
    `lib/testing/module-harness.nix`, `packages/*/checks/module-eval.nix`,
