...
- **`pipeline`**
  - Match: `.github/workflows/update.yml`, `config/fragment-categories.nix`,
    ...
    `dev/generate.nix`, `dev/instructions.nix`, `dev/scripts/update-*.sh`,
    `dev/tasks/generate.nix`, `lib/ai/transformers/**`,
    `lib/fragments-registry.nix`, `lib/fragments.nix`, `lib/update.nix`,
    `overlays/**/*.update.nix`
  - Read:
...
- **`worktree-session`**
  - Match: `dev/instructions.nix`, `lib/worktree-session.nix`
  - Read:
    [`dev/fragments/worktree-session/worktree-session.md`](dev/fragments/worktree-session/worktree-session.md)
