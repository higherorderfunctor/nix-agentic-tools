...
- [Home-Manager Setup](./getting-started/home-manager.md)
- [DevEnv Setup](./getting-started/devenv.md)
- [Manual lib Usage](./getting-started/manual-lib.md)
...
- [Configuration Parity](./concepts/config-parity.md)
