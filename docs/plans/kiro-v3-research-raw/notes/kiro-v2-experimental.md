...
> Advanced features in active development for Kiro CLI
...
**⚠️ Warning:** These features may change or be removed at any time. The experience might not be perfect. Use at your own discretion in production workflows.
...
[Learn more about Knowledge Management →](https://kiro.dev/docs/cli/experimental/knowledge-management.md)
...
[Learn more about Tangent Mode →](https://kiro.dev/docs/cli/experimental/tangent-mode.md)
...
[Learn more about TODO Lists →](https://kiro.dev/docs/cli/experimental/todo-lists.md)
...
[Learn more about Thinking Tool →](https://kiro.dev/docs/cli/experimental/thinking.md)
...
[Learn more about Checkpointing →](https://kiro.dev/docs/cli/experimental/checkpointing.md)
...
[Learn more about Delegate →](https://kiro.dev/docs/cli/experimental/delegate.md)
...
- [Knowledge Management](https://kiro.dev/docs/cli/experimental/knowledge-management.md)
- [Tangent Mode](https://kiro.dev/docs/cli/experimental/tangent-mode.md)
- [TODO Lists](https://kiro.dev/docs/cli/experimental/todo-lists.md)
- [Settings Configuration](https://kiro.dev/docs/cli/reference/settings.md)
