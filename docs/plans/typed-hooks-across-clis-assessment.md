...
| **Turn / tool-call minimization** | `PreToolUse` (gate/rewrite), `PostToolUse` (`additionalContext`), `UserPromptSubmit`                  | `tool_name`, `tool_input`                                                          | `permissionDecision`, `updatedInput`, `additionalContext` | `prek-stop-hook-validator.md`                               |
