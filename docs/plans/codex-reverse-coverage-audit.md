...
> now live under `ai.codex.native.settings`). Prior: 2026-08-02 against
...
| --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `--ask-for-approval.acceptedValues`     | Typed preset branch of `ai.codex.native.settings.approval_policy`; now read directly instead of duplicating the three values                                 |
| `--sandbox.acceptedValues`              | Typed `ai.codex.native.settings.sandbox_mode`; now read directly instead of duplicating the three values                                                     |
| Stable feature names                    | Generated typed children of `ai.codex.native.settings.features`                                                                                              |
