...
exist here). Pages and payloads land under `output/view/`, gitignored. Three
roots exist: `NAR-SEMANTIC-LAYER` (the whiteboard as a tree of narratives,
...
place, 4 held for the operator, 104 stayed). Published copies (private
artifacts, regenerated by hand from `output/view/`):
https://claude.ai/code/artifact/9cdae156-301a-4baa-8d20-585dd6125d4e (the
whiteboard),
https://claude.ai/code/artifact/3cf4b312-09d4-4b87-bc33-c3a77524509d (the view's
own design),
https://claude.ai/code/artifact/ec3d6ef1-8134-4369-9a8f-741239a60d15 (the
mechanism sort).
