...
# it.
#
# Native owner discovery publishes this backend through
...
# `checks/strictdoc/strictdoc-grammar-model-equal.nix` is what notices.
#
...
# published surface may use this module, call `lib.ai.strictdocGrammar`'s `render`
...
# keeps the module importable by a project that has no such tasks.
{
  ...
  grammar = import ../../lib/grammar.nix {inherit lib;};
