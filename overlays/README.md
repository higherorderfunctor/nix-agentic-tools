...
| copilot-cli | root | nvfetcher: GitHub release binary | pre-built binary (nixpkgs override) | `copilot-cli` | release tags | — | yes | Proprietary pre-built binary, per-platform |
