{
  ...
  in {
    ...
    checks = forAllSystems (system: let
      ...
      strictdocNixExtractorCheck = {strictdoc-nix-extractor = import ./checks/strictdoc-nix-extractor.nix {inherit pkgs self strictdocGrammarExtract;};};
      strictdocSemanticsCheck = {strictdoc-semantics = import ./checks/strictdoc-semantics.nix {inherit pkgs self strictdocGrammarExtract;};};
