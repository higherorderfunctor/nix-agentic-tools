---
applyTo: ".github/workflows/update.yml,config/generate-update-ninja.nix,config/update-targets.nix,dev/generate.nix,dev/scripts/update-*.sh,dev/tasks/generate.nix,lib/ai/transformers/**,lib/fragments.nix,lib/update.nix,overlays/**/*.update.nix"
---
