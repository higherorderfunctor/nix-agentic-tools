---
applyTo: "lib/ai/hm-helpers.nix,lib/ai/mkSkillPackageModule.nix,packages/chatgpt-codex/lib/mkCodex.nix,packages/chatgpt-codex/modules/**,packages/claude-code/lib/mkClaude.nix,packages/claude-code/modules/**,packages/copilot-cli/lib/mkCopilot.nix,packages/copilot-cli/modules/**,packages/delegate-sizing/modules/**,packages/kimchi/lib/mkKimchi.nix,packages/kimchi/modules/**,packages/kiro-cli/lib/mkKiro.nix,packages/kiro-cli/modules/**,packages/stacked-workflows/modules/**"
---
