...
- Are the per-skill `packages/stacked-workflows/references/` symlinks pointing
  to files that exist?
- Do skill instructions match what the reference docs say about commands? (e.g.,
  does stack-fix's absorb instructions match
