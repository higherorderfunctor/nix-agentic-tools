...
SOURCE_EXTRACTORS: dict[str, SourceExtractor] = {
    ...
    "packages/claude-code/checks/fixtures/claude-hooks/post-edit": BASH_SOURCE_EXTRACTOR,
    "packages/claude-code/checks/fixtures/claude-hooks/pre-edit": BASH_SOURCE_EXTRACTOR,
}
