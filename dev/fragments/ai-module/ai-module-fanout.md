...
> **Last verified:** 2026-09-21 — `ai.codex.profiles` is removed, delivery
> diagnostics distinguish excluded root pools from per-runtime requests, and
> `migrationConfig` retires files through an empty `own` target.
>
