...
> **Last verified:** 2026-09-19 — everything a generation owns reconciles
...
> deleted. The "parity does not require identical delivery paths" worked example
> below is now `ai.codex.execpolicyRules`, not the removed `ai.codex.profiles`.
>
> Full lineage:
