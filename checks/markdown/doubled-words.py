...
THIS SECTION IS THE ONLY HOME OF THESE NUMBERS. checks/markdown/doubled-words.nix
...
scan quietly deleted more prose. checks/markdown/fixtures/doubled-words/ carries
...
checks/markdown/doubled-words-fixtures.nix. Add a fixture with every rule change.
...
checks/markdown/fixtures/doubled-words/hyphen-glue.md.fixture.
