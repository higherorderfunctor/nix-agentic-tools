#!/usr/bin/env python3
"""Run doubled_words against the committed fixtures in checks/markdown/fixtures/doubled-words.
...
`checks/markdown/markdown-scan.nix` scans every tracked `.md` in the tree, so a `.md`
...
def _load(module, filename):
    ...
    makes this runnable by hand:
        ...
        python3 checks/markdown/doubled-words-fixtures.py checks/markdown/fixtures/doubled-words
