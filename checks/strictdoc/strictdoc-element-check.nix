...
# checks/strictdoc/strictdoc-element-check.nix -- the CI gate for element-grained File
...
# outside. checks/strictdoc/strictdoc-file-check.nix cannot see it: that gate checks the
