# checks/strictdoc/strictdoc-commentary-check.nix -- the CI gate for the COMMENTARY
...
# packages/strictdoc-grammar/checks/strictdoc-grammar-negative-fixtures.nix: a green over an empty set
...
# checks/strictdoc/strictdoc-file-check.nix: `strictdoc export` caches under its output
