# checks/strictdoc/strictdoc-cycle-check.nix -- SLICE-GRAPH-CHECKS's CI gate for
...
# checks/strictdoc/strictdoc-fp-check.nix: `strictdoc export` caches under its output
