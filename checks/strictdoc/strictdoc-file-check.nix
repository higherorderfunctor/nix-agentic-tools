# checks/strictdoc/strictdoc-file-check.nix -- the CI gate for
...
# checks/strictdoc/strictdoc-cycle-check.nix: `strictdoc export` caches under its output
...
pkgs.runCommand "strictdoc-file-check" (sdocTsEnv
  // {
