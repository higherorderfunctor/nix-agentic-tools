...
# checks/strictdoc/strictdoc-nix-extractor.nix -- the CI gate for the tree-sitter source
...
pkgs.runCommand "strictdoc-nix-extractor" {
  nativeBuildInputs = [
    ...
    # load-bearing -- the same reason checks/markdown/doubled-words-fixtures.nix spells
