# checks/strictdoc/strictdoc-grammar-corpus.nix — SLICE-SDOC-IN-SEMBLE's corpus/
# regression suite for the patched tree-sitter-strictdoc grammar
# (packages/tree-sitter-strictdoc/packages/ai/generic/tree-sitter-strictdoc/package.nix). Upstream ships zero tests for
